...
import (
	...
	"github.com/ChristopherScot/resume/client"
...
func makeClient(cmd *cobra.Command, args []string) (*client.Resume, error) {
...
func MakeRootCmd() (*cobra.Command, error) {
	...
	operationGroupOpenCmd, err := makeOperationGroupOpenCmd()
	if err != nil {
		return nil, err
	}
	rootCmd.AddCommand(operationGroupOpenCmd)
...
func makeOperationGroupOpenCmd() (*cobra.Command, error) {
	operationGroupOpenCmd := &cobra.Command{
		Use:  "open",
		Long: ``,
	}

	operationCreateResumeCmd, err := makeOperationOpenCreateResumeCmd()
	if err != nil {
		return nil, err
	}
	operationGroupOpenCmd.AddCommand(operationCreateResumeCmd)

	operationDeleteResumeCmd, err := makeOperationOpenDeleteResumeCmd()
	if err != nil {
		return nil, err
	}
	operationGroupOpenCmd.AddCommand(operationDeleteResumeCmd)

	operationGetAPIIdentifierCmd, err := makeOperationOpenGetAPIIdentifierCmd()
	if err != nil {
		return nil, err
	}
	operationGroupOpenCmd.AddCommand(operationGetAPIIdentifierCmd)

	operationGetResumeCmd, err := makeOperationOpenGetResumeCmd()
	if err != nil {
		return nil, err
	}
	operationGroupOpenCmd.AddCommand(operationGetResumeCmd)

	operationUpdateResumeCmd, err := makeOperationOpenUpdateResumeCmd()
	if err != nil {
		return nil, err
	}
	operationGroupOpenCmd.AddCommand(operationUpdateResumeCmd)

	return operationGroupOpenCmd, nil
}
