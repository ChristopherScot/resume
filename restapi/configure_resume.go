...
//go:generate swagger generate server --target ../../resume --name Resume --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.ResumeAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.ResumeAPI) http.Handler {
