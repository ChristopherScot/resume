...
// ContextValidate validates this simple message response based on context it is used
func (m *SimpleMessageResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
