	...
	if m.Object1 != nil {
		if err := m.Object1.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("object1")
			}
			return err
		}
	}
	...
	if m.Object2 != nil {
		if err := m.Object2.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("object2")
			}
			return err
		}
	}
...
// ContextValidate validate this complex object response based on the context it is used
func (m *ComplexObjectResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateObject1(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateObject2(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ComplexObjectResponse) contextValidateObject1(ctx context.Context, formats strfmt.Registry) error {

	if m.Object1 != nil {

		if err := m.Object1.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("object1")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("object1")
...
func (m *ComplexObjectResponse) contextValidateObject2(ctx context.Context, formats strfmt.Registry) error {

	if m.Object2 != nil {

		if err := m.Object2.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("object2")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("object2")
