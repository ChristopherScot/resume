...
// ContextValidate validates this simple object one based on context it is used
func (m *SimpleObjectOne) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
