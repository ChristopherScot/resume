...
// ContextValidate validates this simple object two based on context it is used
func (m *SimpleObjectTwo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
